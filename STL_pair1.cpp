...
int main()
{
    ...
    a2 = {5, 2};
    if (a1 > a2)
        cout << "a1 is greater than a2" << endl; // Compare pairs
    else
    ...
    // find()
    cout << "------find()--------" << endl;
    vector<pair<int, int>> vp1 = {{1, 2}, {2, 3}, {4, 5}, {1, 2}, {1, 2}};
    auto it = find(vp1.begin(), vp1.end(), make_pair(2, 3));
    cout << it->first << " " << it->second << endl;

    // count()
    cout << "--------count()----------" << endl;
    cout << count(vp1.begin(), vp1.end(), make_pair(1, 2))<<endl;

    // binary_search()
    cout << "--------binary_search()----------" << endl;
    sort(vp1.begin(), vp1.end());
    cout << binary_search(vp1.begin(), vp1.end(), make_pair(2, 3));
    return 0;
}
